        ...
        for img in os.listdir(file_type):
            if file_type == 'negatives':
                ...
                with open('bg.txt','a') as f:
                    f.write(line)
def samplePrep():
    sample = cv.imread("Lenna_(test_image).png",0)
    resizedSample = sample# cv.resize(sample,(50,50))
    cv.imwrite("Lenna_(test_image)grey.png", resizedSample)

def threshHoldSample():
